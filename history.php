...
// Query untuk menghitung jumlah siswa di history
$historyData = mysqli_query($conn, "SELECT * FROM history");
$count3  = mysqli_num_rows($historyData);
...
<head>
    ...
    <style>
        ...
        @media screen and (max-width: 600px) {
            table {
                display: block; /* Mengubah tabel menjadi block untuk scrolling */
                width: 100%;
    ...
    <section id="content">
        ...
        <nav>
            ...
            <a href="notifikasi.php" class="notification">
                ...
                <span class="num"><?= $count3; ?></span> <!-- Jumlah notifikasi -->
            </a>
        ...
        <main>
            <div class="head-title">
                ...
                <a href="export/exporthistory.php" class="btn-download">
            ...
            <ul class="box-info3">
                ...
                <li>
                    ...
                    <span class="text">
                        <h3><?= $count3; ?></h3>
                        <p>Jumlah siswa izin keluar & pulang</p>
                    </span>
                </li>
            </ul>
                ...
                <div class="order">
                    ...
                    <table>
                        ...
                        <tbody id="tableBody">
                            ...
                            <?php while ($row = mysqli_fetch_assoc($historyData)) : ?>
                            <tr>
                                <td><?= $i++; ?></td>
                                <td>
                                ...
                                <td>
                                    <?php
                                        ...
                                        } else if (strtolower($row['status']) === 'izin pulang') { // Tambahkan kondisi untuk izin pulang
                                ...
                                <td>
                                    <a href="hapushistory.php?id=<?= $row['id']; ?>" class="btn-hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus?')">Hapus</a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
