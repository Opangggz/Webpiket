...
<head>
    ...
    <script>
        ...
        // Fungsi untuk mengatur tanggal keluar siswa ke tanggal saat ini
...
<body>
    <div class="wrap">
        ...
        <h2>IZIN SISWA KELUAR</h2>
        <form action="pskeluar.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" required>
                    <option value="Izin keluar" selected>Izin keluar</option>
                </select>
            </div>
            
            <div class="form-group">
                <label for="tanggal_izin">Tanggal keluar siswa:</label>
